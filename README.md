# MyReads Project
MyReads is a simple book management app for the Udacity Front End Project (6).This project can be used to search for book titles and store them on different shelves. Each shelf is titled *currently reading*, *what you have read* and what you would like to *read*.
